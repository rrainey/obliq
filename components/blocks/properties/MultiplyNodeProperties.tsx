    ...
    <div className="space-y-4">
      ...
      <div className="pt-2 border-t border-gray-200">
        ...
        <p className="text-sm text-gray-600">
          The Multiply block multiplies all input values and outputs the result. Connect multiple
          signals to the inputs and the product will be sent to the output.
        </p>
      </div>
    </div>
  );
